...
window.SmartRosaryLocales.en = (FW_VERSION, LANG_VERSION) => ({
  ...
  intentionsCatalogLoading: "Loading intentions…",
  intentionsCatalogError: "Could not load intentions. Retry to select packages or single intentions.",
  intentionsChoose: "Select one or more packages or single intentions.",
  intentionsOptional: "Optional: select packages or single intentions to include.",
  intentionsSelected: "{count} / 32 intentions selected. They will be combined into one upload.",
  intentionsTooMany: "Select at most 32 intentions in total.",
